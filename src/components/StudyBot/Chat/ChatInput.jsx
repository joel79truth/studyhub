...
import SnapModal from '../../SnapLearn/SnapModal';
    ...
    <>
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          aria-label="Snap a question photo"
          title="Snap or upload an exam question"
          style={{
            width: '40px',
            height: '40px',
            borderRadius: '50%',
        ...
        <textarea
          ...
          onChange={resize}
          onKeyDown={onKey}
          placeholder={hasKey ? 'Ask StudyHub or snap a question photo…' : 'Add your Gemini API key to start…'}
          rows={1}
        ...
        {loading ? (
          ...
          <button
            ...
            style={{
              ...
              height: '40px',
              borderRadius: '50%',
              background: canSend ? 'linear-gradient(135deg,#064e3b,#043226)' : '#dde5f5',
              border: 'none',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              ...
              flexShrink: 0,
              boxShadow: canSend ? '0 2px 10px rgba(6,78,59,0.32)' : 'none',
